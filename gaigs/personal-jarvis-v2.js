...
(function () {
  ...
  async function handleJarvisAction(actionName) {
    ...
    if (actionName === "checkUpdate") {
      ...
      toast("Reviewed release channel checked. Updates install through the signed app/PWA release path."); return;
    }
